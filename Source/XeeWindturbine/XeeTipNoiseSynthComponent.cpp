...
#include "XeeTipNoiseSynthComponent.h"


bool UXeeTipNoiseSynthComponent::Init(int32& SampleRate)
{
	NumChannels = 1;
...
int32 UXeeTipNoiseSynthComponent::OnGenerateAudio(float* OutAudio, int32 NumSamples)
{
#if SYNTHCOMPONENT_EX_OSCILATOR_ENABLED
...
void UXeeTipNoiseSynthComponent::SetFrequency(const float InFrequencyHz)
{
#if SYNTHCOMPONENT_EX_OSCILATOR_ENABLED
